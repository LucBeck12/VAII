<div class="zaklad modrePozadie">
    ...
    <form method="post">
        <input type="text" class="form-control" id="nazov" placeholder="Zadajte názov" name="nadpis" autocomplete="off">
        ...
        <a href="?c=forum" id="cancel" class="btn btn-default">Zrušiť</a>
